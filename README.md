...
**AI Athlete Performance & Career Agent** — AI-агент для спортсменов, который
собирает результаты, соревнования, нормативы и обратную связь в единый
проверяемый контекст и историю прогресса.
